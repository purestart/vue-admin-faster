...
<template>
  <div class="personImfo">
    ...
    <div style="margin-top:15px;" class="base-info">
      <div class="personImfo-header">
      <div class="title">联系信息</div>
      <!-- <a href="javascript:void(0)">返回</a> -->
    </div>
    <div class="content">
        <el-form ref="ruleform" :model="contact" label-width="120px" label-position="right" size="small"  :status-icon="true">
      ...
      data() {
        return {
          ...
          rules: {
            ...
            type: [
              { type: 'string', required: true, message: '请至少选择一张图片', trigger: 'click' }
            ],
            resource: [
