<template>
  <div class="page-sys--list">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
          <el-button size="small" v-if="$hasPermission('sys:sys-menu:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
      </el-form-item>
      <el-form-item>
          <el-button size="small" v-if="$hasPermission('sys:sys-menu:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
...
<script>
  import AddOrUpdate from './sys-menu-add-or-update'
  export default {
    data () {
      return {
        dataForm: {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$axios.get(
          `${this.$baseUrl}/sys/sys-menu/list`,
          {
              params: {
                  'page': this.pageIndex,
                  'limit': this.pageSize,
