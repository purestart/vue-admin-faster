...
const genTableService = require('../../service/dept/tb-depts-service');
const config=require("../../config/generator-config");

module.exports =[
    {
        url:"/dept/tb-depts/info/:id",
        method:"get",
        function:async ctx=>{
    ...
    },
    {
        ...
        function:async ctx=>{
            ...
            const ret = await genTableService.nav();
