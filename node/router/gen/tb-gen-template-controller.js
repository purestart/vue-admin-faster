...
const genTableService = require('../../service/gen/tb-gen-template-service');
const config=require("../../config/generator-config");

module.exports =[
    {
        url:"/gen/tb-gen-template/info/:id",
        method:"get",
        function:async ctx=>{
    ...
    {
        url:"/gen/tb-gen-template/delete",
        method:"post",
        function:async ctx=>{
            //const id=ctx.request.query.id;
            //const id=ctx.params.id;
    ...
    {
        url:"/gen/tb-gen-template/create",
        method:"post",
        function:async ctx=>{
    ...
    {
        url:"/gen/tb-gen-template/update",
        method:"post",
        function:async ctx=>{
            let obj = ctx.request.body;
