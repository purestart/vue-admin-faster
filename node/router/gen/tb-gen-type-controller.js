...
const genTableService = require('../../service/gen/tb-gen-type-service');
const config=require("../../config/generator-config");

module.exports =[
    {
        url:"/gen/tb-gen-type/info/:id",
        method:"get",
        function:async ctx=>{
