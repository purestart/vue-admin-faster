...
const genTableService = require('../../service/auto-form/auto-form-service');
const config=require("../../config/generator-config");

module.exports =[
    {
        url:"/auto-form/auto-form/info/:id",
        method:"get",
        function:async ctx=>{
    ...
    {
        url:"/auto-form/auto-form/delete",
        method:"post",
        function:async ctx=>{
            //const id=ctx.request.query.id;
            //const id=ctx.params.id;
    ...
    {
        url:"/auto-form/auto-form/create",
        method:"post",
        function:async ctx=>{
    ...
    {
        url:"/auto-form/auto-form/update",
        method:"post",
        function:async ctx=>{
            let obj = ctx.request.body;
