...
const genTableService = require('../../service/project/project-ctrl-service');
const config=require("../../config/generator-config");

module.exports =[
    {
        url:"/project/project-ctrl/info/:id",
        method:"get",
        function:async ctx=>{
    ...
    {
        url:"/project/project-ctrl/delete",
        method:"post",
        function:async ctx=>{
            //const id=ctx.request.query.id;
            //const id=ctx.params.id;
    ...
    {
        url:"/project/project-ctrl/create",
        method:"post",
        function:async ctx=>{
    ...
    {
        url:"/project/project-ctrl/update",
        method:"post",
        function:async ctx=>{
            let obj = ctx.request.body;
