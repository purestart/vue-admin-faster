        ...
        <edit-model @submit="saveItem()" title="我的标题" :modelVisible="editModelVisible" @close="editModelVisible=false">
            <div class="edit-content">
                <el-form size="small" :model="formData" label-width="110px">
                    <el-row>
                        <el-col :span="12">
                            <el-form-item  prop="name" class="text-width" label="数据库名称">
                                <el-input  v-model="formData.name"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">

                            <el-form-item  prop="name" class="text-width" label="数据库别名">
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item  prop="name" class="text-width" label="类型">
                        ...
                        <el-col :span="12">
                        <el-form-item  prop="name" class="text-width"  label="数据库地址">
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item  prop="name" class="text-width"  label="用户名">
                                <el-input  v-model="formData.user"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item  prop="name" class="text-width"  label="密码">
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item  prop="name" class="text-width"  label="端口">
